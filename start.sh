...
# ==============================================
# 3. ПРИМЕНЯЕМ МИГРАЦИИ (с синхронным драйвером)
# ==============================================
echo ""
...
# Восстанавливаем оригинальный URL для приложения
export DATABASE_URL="$ORIGINAL_DATABASE_URL"

# ==============================================
# 4. СОЗДАЁМ АДМИНИСТРАТОРА (с асинхронным драйвером)
# ==============================================
echo ""
...
# ==============================================
# 6. ЗАПУСК NGINX (предварительно удаляем стандартный конфиг на всякий случай)
# ==============================================
echo ""
echo "🚀 Удаляем возможный дублирующий конфиг nginx..."
